    ...
    bs4Dash::bs4DashPage(
      ...
      bs4Dash::bs4DashSidebar(
        ...
        bs4Dash::sidebarMenu(
          ...
          bs4Dash::menuItem(bil("Samples", "Muestras"),       tabName = "sample",       icon = shiny::icon("vial")),
          bs4Dash::menuItem(bil("Experiment", "Experimento"), tabName = "experimental", icon = shiny::icon("flask")),
          bs4Dash::menuItem(bil("Ontology", "Ontología"),     tabName = "ontology",     icon = shiny::icon("sitemap")),
          bs4Dash::menuItem(bil("Germplasm", "Germoplasma"),  tabName = "germplasm",    icon = shiny::icon("seedling")),
